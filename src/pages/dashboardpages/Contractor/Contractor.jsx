...
const tenantData = [
    ...
    },
    {
        ...
        address: "Cape Town, Green Point",
        joinDate: "06-18-2024",
        endDate: "06-18-2025",
        avatar: "/male-avatar-9.png",
    },
    {
        id: "19",
        name: "Thandiwe Ndlovu",
        email: "t.ndlovu@example.com",
        address: "Durban, Morningside",
        joinDate: "07-30-2024",
        endDate: "07-30-2025",
        avatar: "/female-avatar-10.png",
    },
...
export default function Managers() {
    ...
    return (
        <div className="">
            <div className="">
                <div className="mb-4">
                    <h1 className="text-2xl font-semibold text-gray-900">Contactor List</h1>
                </div>
                ...
                <Table>
                    <TableHeader>
                        <TableRow className="bg-orange-500 hover:bg-orange-500">
                            ...
                            <TableHead className="text-white font-semibold text-center">Contactor Name</TableHead>
