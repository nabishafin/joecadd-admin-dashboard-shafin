...
const TermsAndConditions = () => {
  ...
  return (
    <div className="font-sans pr-5">
      {/* Header */}
      <h2 className="text-xl sm:text-2xl font-bold mb-5 text-white bg-[#FF6600] p-5 rounded-lg">
      ...
      <div className="flex justify-end p-4">
        <Link to="/dashboard/settings/editterms">
          <Button className="bg-[#FF6600] hover:bg-[#FF6600] text-white rounded-full flex items-center space-x-1 shadow-md">
