      ...
      <div className="w-full max-w-5xl flex items-center justify-center gap-16">
        ...
        <div className="hidden lg:flex items-center justify-center flex-1">
          <div className="relative">
            <div className=" ">
              <img src={logo} alt="Logo" className=" h-[520px]" />
            </div>
          </div>
        </div>
          ...
          <Card className="shadow-lg border border-gray-200">
            ...
            <CardContent className="space-y-6 px-8 pb-10">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  {otp.map((digit, index) => (
                    <Input
                      ...
                      className={`w-14 h-14 text-center text-xl font-bold border-2 rounded-md ${
                        error
                          ? "border-[#FF6600]/40 focus:border-[#FF6600]"
                          : "border-gray-300 focus:border-[#FF6600]"
                      } focus:ring-[#FF6600]`}
                    />
                  ))}
                </div>
                ...
                {error && (
                  <p className="text-base text-[#FF6600] text-center">
                    {error}
                  </p>
                )}
                ...
                <Button
                  ...
                  className="w-full h-12 text-[16px] bg-gradient-to-b from-[#FF6600] to-[#FF6600] hover:from-[#FF6600] hover:to-[#FF6600] disabled:opacity-50 text-white font-semibold transition-all duration-200"
                >
