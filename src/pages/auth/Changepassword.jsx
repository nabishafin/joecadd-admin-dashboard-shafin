...
export default function ChangedPassword() {
  ...
  return (
    <div className=" ">
      {/* Header */}
      <div className="bg-[#FF6600] text-white p-4">
      ...
      <div className="flex justify-center items-start pt-16 px-4">
        <Card className="w-full max-w-md shadow-lg">
          <CardHeader className="text-center pb-6">
            <CardTitle className="text-xl font-semibold text-[#FF6600]">
              Change Password
            </CardTitle>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button
                type="submit"
                className="w-full bg-[#FF6600] hover:bg-[#FF6600] text-white h-12 text-base font-medium rounded-lg"
              >
                Save Changes
              </Button>
            </form>
